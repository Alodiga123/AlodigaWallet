...
public class BalanceInquiryWithoutMovementsCredential extends Response implements Serializable {
    ...
    public BalanceInquiryWithoutMovementsCredential() {
    }

    public BalanceInquiryWithoutMovementsCredential(String codeError, String messageError, String codeAnswer, String messageResponse, String codeAuthorization, String availableConsumption, String availableQuotas, String availableAdvances, String availableLoans, String balance, String balanceInDollars, String minimumPayment, String expirationDateLastSettlement) {
    ...
    public String toString() {
        return "BalanceInquiryWithoutMovementsCredential{" + "codeError=" + codeError + ", messageError=" + messageError + ", codeAnswer=" + codeAnswer + ", messageResponse=" + messageResponse + ", codeAuthorization=" + codeAuthorization + ", availableConsumption=" + availableConsumption + ", availableQuotas=" + availableQuotas + ", availableAdvances=" + availableAdvances + ", availableLoans=" + availableLoans + ", balance=" + balance + ", balanceInDollars=" + balanceInDollars + ", minimumPayment=" + minimumPayment + ", expirationDateLastSettlement=" + expirationDateLastSettlement + '}';
    }

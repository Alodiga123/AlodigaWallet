...
public class LimitAdvanceCredential extends Response implements Serializable {
    ...
    public LimitAdvanceCredential() {
    }

    public LimitAdvanceCredential(String codeError, String messageError, String codeAnswer, String messageResponse, String codeAuthorization) {
